    ...
    return Scaffold(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              ...
              if (context.mounted) Navigator.pushReplacementNamed(context, '/admin-login');
            },
          ),
        ],
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text('Overview', style: GoogleFonts.poppins(fontSize: 24, fontWeight: FontWeight.bold, color: const Color(0xFF1A237E))),
            ...
            GridView.count(
              ...
              children: [
                ...
                _buildAdminCard(Icons.local_shipping, 'Drivers', '67', Colors.orange),
                _buildAdminCard(Icons.shopping_cart, 'Active Orders', '34', Colors.purple),
              ],
            ),
            const SizedBox(height: 24),
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) => Card(
          ...
          child: ListTile(
            ...
            title: Text('User ${index + 1}', style: GoogleFonts.poppins(fontWeight: FontWeight.w500)),
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text('Revenue: \$12,450', style: GoogleFonts.poppins(fontSize: 20, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            Text('Total Transactions: 342', style: GoogleFonts.poppins(fontSize: 16)),
