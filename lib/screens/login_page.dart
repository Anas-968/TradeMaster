    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (response.user != null) {
          ...
          final isAdmin = response.user!.userMetadata?['is_admin'] as bool? ?? false;
              ...
              Center(
                child: Column(
                  children: [
                    ...
                    Text('Welcome Back!', style: GoogleFonts.poppins(fontSize: 28, fontWeight: FontWeight.bold, color: const Color(0xFF1A237E))),
                    const SizedBox(height: 8),
                    Text('Login to your account', style: GoogleFonts.poppins(fontSize: 14, color: Colors.grey[600])),
                  ],
                ),
              ),
              ...
              Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Password', style: GoogleFonts.poppins(fontWeight: FontWeight.w600, fontSize: 14, color: const Color(0xFF1A237E))),
                    const SizedBox(height: 8),
                    TextFormField(
                    ...
                    Align(
                      ...
                      child: TextButton(
                        ...
                        child: Text('Forgot Password?', style: GoogleFonts.poppins(color: const Color(0xFF1A237E), fontWeight: FontWeight.w500)),
                      ),
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          ...
                          child: Text('Register', style: GoogleFonts.poppins(color: const Color(0xFF1A237E), fontWeight: FontWeight.bold)),
                        ),
                      ],
                    ),
                  ],
